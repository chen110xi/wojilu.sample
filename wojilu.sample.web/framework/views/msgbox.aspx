...
<div style="width:400px; margin:10px auto; padding:30px 0px; text-align:center; font-size:26px; font-weight:bold; font-family:Microsoft YaHei; color:red; line-height:150%;">#{msg}</div>

<script data-main="~js/main" src="~js/lib/require-jquery-wojilu.js?v=#{jsVersion}"></script>
<script>    require(['wojilu._frame']);</script>
</body>
</html>
